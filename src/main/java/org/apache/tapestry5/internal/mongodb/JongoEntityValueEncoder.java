 ...
 *
 */
public class JongoEntityValueEncoder<E> implements ValueEncoder<E>
{

	private final Class<E> entityClass;

	private final JongoSessionSource jongoSessionSource;
	...
	public JongoEntityValueEncoder(Class<E> entityClass, JongoSessionSource jongoSessionSource,
							   PropertyAccess propertyAccess, TypeCoercer typeCoercer, Logger logger)
	{
		this.entityClass = entityClass;
		this.jongoSessionSource = jongoSessionSource;
	...
	public E toValue(String clientValue)
	{
		...
		E result = (E) jongoSessionSource.openDefaultDatastore().get(entityClass, id);
